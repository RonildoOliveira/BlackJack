...
public class ChatServer {
    ...
    static List<String> baralho;
	
    static List<String> parados;
    
    static List<String> maoServer;
    ...
    public static void main(String[] args) throws Exception {
        ...
        ServerSocket listener = new ServerSocket(Config.PORTA);
        try {
            while (true) {
    ...
    private static class Handler extends Thread {
        ...
        public Handler(Socket socket) {
            ...
            maoServer = new ArrayList<String>();
            
            parados = new ArrayList<String>();
        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    if(input.contains(Config.PARAR)){
